...
func TestPulseHKDF_KnownValues(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedSalt:            mustHexDecode("f251131af30fbb0b575df1d6146b1f8bb9ac6465789d96f841af0787c520baab"),
			expectedPrk:             mustHexDecode("bf59ed8f0314c504009f1e0ff45c0c17237ac567d56dd83434ae88edd8b6ebe6"),
			...
			expectedAESKey:          mustHexDecode("fdc47c91d9783d3904ea193f5cab4245d1c6cc1363a1925bc1a996db3fd9e39f"),
			expectedAESNonce:        mustHexDecode("3a46a68f32164320ed05f220"),
		},
		{
			...
			expectedSalt:            mustHexDecode("de797964f0d863c4163dde69f3d675eb59a18a569c4043e70b472888e1f796d9"),
			expectedPrk:             mustHexDecode("df876f12e60b6fa7f9d174869ce169873f351a16bcae783d0aedbfe7ff905c58"),
			...
			expectedAESKey:          mustHexDecode("9db3027d1cd914e597f8adcae7e546f3f0495eafc8ed4a1e32bbfc94d625e706"),
			expectedAESNonce:        mustHexDecode("c7439399def2cc23269f3943"),
		},
	}
